...
const faqs = [
  ...
  { q: "Is a refundable security deposit required?", a: "Yes. A $250 refundable deposit is required, and is returned 14 to 30 days after rental ends, less any tolls, tickets, or damage." },
